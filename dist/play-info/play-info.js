...
Object.assign(MediaElementPlayer.prototype, {
    ...
    createPlayInfo: function createPlayInfo() {
        ...
        var element = t.playInfo,
            ...
            description = element['data-play-info-description-link'] ? '<a target="_blank" href="' + element['data-play-info-description-link'] + '"><div class="' + t.options.classPrefix + 'play-info-item-description-linked">' + element['data-play-info-description'] + '</div></a>' : element['data-play-info-description'] ? '<div class="' + t.options.classPrefix + 'play-info-item-description">' + element['data-play-info-description'] + '</div>' : '',
