		...
		browserify: {
			dist: {
				files: {
					...
					'dist/play-info/play-info.js': 'src/play-info/play-info.js',
		...
		postcss: {
			uncompressed: {
				...
				files: {
					...
					'dist/play-info/play-info.css': 'src/play-info/play-info.css',
			...
			compressed: {
				...
				files: {
					...
					'dist/play-info/play-info.min.css': 'dist/play-info/play-info.css',
